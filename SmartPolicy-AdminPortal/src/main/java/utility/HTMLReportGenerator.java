...
public class HTMLReportGenerator {
	...
	{
		isShowImage=true;
		HTMLReportGenerator.imageFolderPath=ImageFolderPath;
		TestSuiteStart(HTMLFilePath,UserName);
	}
	...
	public static void TestCaseStart(String TestName,String string)
	{
		testcaseobj=testsuiteobj.startTest(TestName, string.toString());
	}
