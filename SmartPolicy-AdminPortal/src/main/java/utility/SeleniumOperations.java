...
//SendKeys
	...
	//SendKeys
		 public static Hashtable<String,Object> sendKeysTwo(Object[] inputparameters)
		      {   
			    try 
		            {
			           driver.manage().timeouts().implicitlyWait(config.getImplicitlyWait(),TimeUnit.SECONDS);
			           String strXpath=(String)inputparameters[0];
			           String strvalue=(String)inputparameters[1];
			           String strXpath1=(String)inputparameters[2];
			           String strvalue1=(String)inputparameters[3];
			           
		               driver.findElement(By.xpath(strXpath)).sendKeys(strvalue);
		               driver.findElement(By.xpath(strXpath1)).sendKeys(strvalue1);
		               outputparameters.put("STATUS","Pass");
			           outputparameters.put("MESSAGE","Method Used:sendKeys, Input Given:"+inputparameters[1]);
	...
	public static Hashtable<String,Object> validation(Object[] inputparameters)
	       {  
		     try
				...
				assertion.assertEquals(givenText, findText);
...
//DropDown
		...
		public static Hashtable<String,Object> sendDropdown(Object[] inputparameters)
	      {   
		    try 
	            {
		           driver.manage().timeouts().implicitlyWait(config.getImplicitlyWait(),TimeUnit.SECONDS);
		           
		           String sendXpath = (String)inputparameters[0];
		           String sendValue = (String)inputparameters[1];
		           driver.findElement(By.xpath(sendXpath)).sendKeys(sendValue);
		           String selectXpath = (String)inputparameters[2];
		           driver.findElement(By.xpath(selectXpath)).click();
	               outputparameters.put("STATUS","Pass");
		           outputparameters.put("MESSAGE","Method Used:dropdown, Input Given:"+inputparameters[2]);
...
//CloseBrowser		
		public static Hashtable<String,Object> CloseBrowser()
	      {   
		    try 
	            {
		           driver.manage().timeouts().implicitlyWait(config.getImplicitlyWait(),TimeUnit.SECONDS);
